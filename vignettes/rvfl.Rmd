...
ridge_relu <- rvfl::rvfl(X = as.matrix(train_data[,-14]), y = train_data$medv)
ridge_sigmoid <- rvfl::rvfl(X = as.matrix(train_data[,-14]), y = train_data$medv, 
                           activation_function = "sigmoid")
ridge_tanh <- rvfl::rvfl(X = as.matrix(train_data[,-14]), y = train_data$medv, 
