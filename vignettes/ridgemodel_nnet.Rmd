...
start <- proc.time()[3]
ridge_model <- rvfl::ridgemodel(X = as.matrix(train_data[,-1]), y = train_data$mpg, workhorse = glmGamma)
print(proc.time()[3] - start)
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::ridgemodel(X = as.matrix(train_data[,-14]), y = train_data$medv, workhorse = glmGamma)
print(proc.time()[3] - start)
print(summary(ridge_model))
#print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
