---
title: "Ridge Gamma model"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Ridge Gamma model}
...
start <- proc.time()[3]
ridge_model <- rvfl::ridgemodel(type_residuals="calibrated", X = as.matrix(train_data[,-1]), y = train_data$mpg, workhorse = glmGamma)
print(proc.time()[3] - start)
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::ridgemodel(type_residuals="calibrated", X = as.matrix(train_data[,-14]), y = train_data$medv, workhorse = glmGamma)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
...
ridge_model <- rvfl::ridgemodel(type_residuals="calibrated", X = as.matrix(train_data[,-which(names(train_data) == "Price")]), 
                               y = train_data$Price, workhorse = glmGamma)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
