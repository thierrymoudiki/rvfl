---
title: "Ridge model (bootstrap) model"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Ridge model (bootstrap) model}
...
start <- proc.time()[3]
ridge_model <- rvfl::ridgemodel(type_residuals="calibrated", X = as.matrix(train_data[,-1]), y = train_data$mpg, seed=123)
print(proc.time()[3] - start)
...
ridge_pred <- predict(ridge_model, newdata = as.matrix(test_data), method="bootstrap", interval = "prediction")
```
