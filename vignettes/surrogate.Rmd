...
start <- proc.time()[3]
ridge_model <- rvfl::calibmodel(lambda=10**seq(-10, 10, 100), X = as.matrix(train_data[,-1]), y = train_data$mpg)
print(proc.time()[3] - start)
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::calibmodel(X = as.matrix(train_data[,-14]), y = train_data$medv)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
