...
start <- proc.time()[3]
ridge_model <- rvfl::calibmodel(X = as.matrix(train_data[,-1]), y = train_data$mpg)
print(proc.time()[3] - start)
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::calibmodel(X = as.matrix(train_data[,-7]), y = train_data$Employed)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::calibmodel(X = as.matrix(train_data[,-16]), y = train_data$y)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::calibmodel(X = as.matrix(train_data[,-which(names(train_data) == "Price")]), 
                               y = train_data$Price)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
