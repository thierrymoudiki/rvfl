---
title: "Ridge model (surrogate) model"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Ridge model (surrogate) model}
...
start <- proc.time()[3]
ridge_model <- rvfl::ridgemodel(type_residuals="calibrated", X = as.matrix(train_data[,-1]), y = train_data$mpg)
print(proc.time()[3] - start)
...
ridge_pred <- predict(ridge_model, newdata = as.matrix(test_data), method="surrogate", interval = "prediction")
```
...
lm_winkler <- misc::misc::winkler_score(mtcars[-train_idx, ]$mpg, results$LM_Lower, results$LM_Upper)
ridge_winkler <- misc::misc::winkler_score(mtcars[-train_idx, ]$mpg, results$Ridge_Lower, results$Ridge_Upper)
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::ridgemodel(type_residuals="calibrated", X = as.matrix(train_data[,-14]), y = train_data$medv)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
...
lm_winkler <- misc::misc::winkler_score(Boston[-train_idx, ]$medv, results$LM_Lower, results$LM_Upper)
ridge_winkler <- misc::misc::winkler_score(Boston[-train_idx, ]$medv, results$Ridge_Lower, results$Ridge_Upper)
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::ridgemodel(type_residuals="calibrated", X = as.matrix(train_data[,-7]), y = train_data$Employed)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
...
lm_winkler <- misc::misc::winkler_score(longley[-train_idx, ]$Employed, results$LM_Lower, results$LM_Upper)
ridge_winkler <- misc::misc::winkler_score(longley[-train_idx, ]$Employed, results$Ridge_Lower, results$Ridge_Upper)
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::ridgemodel(type_residuals="calibrated", X = as.matrix(train_data[,-16]), y = train_data$y)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
...
lm_winkler <- misc::misc::winkler_score(UScrime[-train_idx, ]$y, results$LM_Lower, results$LM_Upper)
ridge_winkler <- misc::misc::winkler_score(UScrime[-train_idx, ]$y, results$Ridge_Lower, results$Ridge_Upper)
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::ridgemodel(type_residuals="calibrated", X = as.matrix(train_data[,-which(names(train_data) == "Price")]), 
                               y = train_data$Price)
print(proc.time()[3] - start)
print(summary(ridge_model))
print(confint(ridge_model))
...
lm_winkler <- misc::misc::winkler_score(car_data[-train_idx, "Price"], results$LM_Lower, results$LM_Upper)
ridge_winkler <- misc::misc::winkler_score(car_data[-train_idx, "Price"], results$Ridge_Lower, results$Ridge_Upper)
