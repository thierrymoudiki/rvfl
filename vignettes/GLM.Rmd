...
start <- proc.time()[3]
ridge_model <- rvfl::calibmodel(X = as.matrix(train_data[,-1]), y = train_data$mpg, engine = glmGamma, lambda=10**seq(-10, 10, 100))
print(proc.time()[3] - start)
...
# Fit calibrated model 
start <- proc.time()[3]
ridge_model <- rvfl::calibmodel(X = as.matrix(train_data[,-14]), y = train_data$medv, engine = glmGamma, lambda=10**seq(-10, 10, 100))
print(proc.time()[3] - start)
print(summary(ridge_model))
#print(confint(ridge_model))
#print(simulate(ridge_model, newdata = test_data))
...
ridge_model <- rvfl::calibmodel(X = as.matrix(train_data[,-which(names(train_data) == "Price")]), 
                               y = train_data$Price, engine = glmGamma, lambda=10**seq(-10, 10, 100))
print(proc.time()[3] - start)
print(summary(ridge_model))
#print(confint(ridge_model))
